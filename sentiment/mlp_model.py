...
# for i in df.index:
#     text = [stremer.stem(word) for word in df.iloc[i,0]]
...
# y_train = [1]*train_range + [0] * train_range
# NB = MultinomialNB()
# model = MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(100,))
model = MLPClassifier()
...
score = accuracy_score(y_res, y_test)
print(score)
